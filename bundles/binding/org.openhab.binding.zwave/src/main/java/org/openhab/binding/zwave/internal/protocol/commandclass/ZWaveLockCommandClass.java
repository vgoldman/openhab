...
public class ZWaveLockCommandClass extends ZWaveCommandClass
	 ...
	 */
	public ZWaveLockCommandClass(ZWaveNode node,
	...
	public void handleApplicationCommandRequest(SerialMessage serialMessage,
		...
		switch (command) {
			...
			case LOCK_REPORT:
				...
				logger.debug(String.format("NODE %d: Lock report - lockState = 0x%02x,",
						this.getNode().getNodeId(), lockState));

				ZWaveLockValueEvent zEvent = new ZWaveLockValueEvent(this.getNode().getNodeId(),
						endpoint, lockState);
	...
	public class ZWaveLockValueEvent extends ZWaveCommandClassValueEvent {
		 ...
		 */
		private ZWaveLockValueEvent(int nodeId, int endpoint,
				 Object value) {
